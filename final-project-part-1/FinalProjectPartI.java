...
public class FinalProjectPartI {
    ...
    public static void main(String[] args){
        System.out.println("What filename do you want to print to?");
        ...
        switch(userInput) {
            case 1: optionOne();
            break;
            case 2: optionTwo(filename);
            break;
            case 3: optionThree(filename);
            break;
    ...
    public static void optionTwo(String filename){
        System.out.println("Please enter number of nodes [between 10,1500]: ");
        int nodes = sc.nextInt();
        while (nodes < 10 || nodes > 1500) {
        ...
        network2.printNetwork(filename);
    }
    ...
    public static void optionThree(String filename){
        ...
        network3.printNetwork(filename);
